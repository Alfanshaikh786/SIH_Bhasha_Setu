          ...
          <div className="relative z-10 lg:col-span-7 bg-gradient-to-br from-[#14532d] via-[#166534] to-[#15803d] rounded-[32px] px-8 sm:px-10 lg:px-12 py-8 lg:py-10 text-white border border-green-800/20 overflow-hidden shadow-xl flex flex-col gap-6">
            ...
            <div className="relative z-10 flex flex-col gap-4">
              ...
              <div className="flex flex-wrap gap-4 mt-2">
                <a
                  href="https://play.google.com/store/apps/details?id=org.anuvadini.bhashini_aadivaani"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="transition hover:scale-105 active:scale-95 bg-black/40 hover:bg-black/60 border border-white/20 rounded-xl px-4 py-2.5 flex items-center gap-3 backdrop-blur-sm"
                >
                  ...
                  <div className="text-left">
                    <span className="block text-[9px] text-green-200 uppercase font-semibold">GET IT ON</span>
                    <span className="block text-xs sm:text-sm font-bold text-white">Google Play</span>
                  </div>
                </a>

                <a
                  href="https://apps.apple.com/in/app/adi-vaani/id6757362249"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="transition hover:scale-105 active:scale-95 bg-black/40 hover:bg-black/60 border border-white/20 rounded-xl px-4 py-2.5 flex items-center gap-3 backdrop-blur-sm"
                >
                  ...
                  <div className="text-left">
                    <span className="block text-[9px] text-green-200 uppercase font-semibold">DOWNLOAD ON</span>
                    <span className="block text-xs sm:text-sm font-bold text-white">App Store</span>
                  </div>
                </a>
              </div>
            </div>

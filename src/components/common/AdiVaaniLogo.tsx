...
interface AdiVaaniLogoProps {
  className?: string;
  size?: 'sm' | 'md' | 'lg';
  showTagline?: boolean;
}

export const AdiVaaniLogo: React.FC<AdiVaaniLogoProps> = ({ 
  className = '', 
  size = 'md',
  showTagline = true 
}) => {
...
// Export alias as BhashaSetuLogo for semantic clarity
export const BhashaSetuLogo = AdiVaaniLogo;
